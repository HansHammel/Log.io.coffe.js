...
(function() {
  var $, Backbone, ClientApplication, ColorManager, LogControlPanel, LogMessage, LogMessages, LogNode, LogNodes, LogScreen, LogScreenView, LogScreens, LogScreensPanel, LogStatsView, LogStream, LogStreams, MESSAGE_CAP, ObjectControls, ObjectGroupControls, ObjectGroupHeader, ObjectItemControls, WebClient, _, _LogObject, _LogObjects, client, colors, io, is_https, jQuery, localStorage, sessionStorage, templates,
  ...
  Backbone.Collection.prototype.update = function(collection) {
    var _ids;
    _ids = _(collection).chain().reduce((function(ids, model) {
      var id, needle;
      id = model.id;
      needle = this.get(id);
      if (needle) {
  ...
  WebClient = (function() {
    function WebClient(opts, localStorage1) {
      var _on;
      if (opts == null) {
        opts = {
          host: '',
      ...
      this.localStorage = localStorage1 != null ? localStorage1 : {};
  ...
  LogScreenView = (function(superClass) {
    ...
    LogScreenView.prototype._recordScroll = function(e) {
      ...
      return this.forceScroll = (parseInt(msgs.height(), 10) + msgs[0].scrollTop) === msgs[0].scrollHeight;
    };
